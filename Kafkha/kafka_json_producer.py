...
FILE_PATH = "C:\\Python codes\\Kafkha\\cardekho_dataset.csv"
columns=['car_name', 'brand', 'model', 'vehicle_age', 'km_driven', 'seller_type',
       'fuel_type', 'transmission_type', 'mileage', 'engine', 'max_power',
       'seats', 'selling_price']

API_KEY = 'CBSTZ5Q7VBSA2TL4'
ENDPOINT_SCHEMA_URL  = 'https://psrc-mw731.us-east-2.aws.confluent.cloud'
API_SECRET_KEY = 'i4kRAu8InAYbJNTgPNPlK1I6IS5yeD4Qy62GOCQ17StNodnnaS20SZgejKmdf+uR'
BOOTSTRAP_SERVER = 'pkc-ymrq7.us-east-2.aws.confluent.cloud:9092'
SECURITY_PROTOCOL = 'SASL_SSL'
SSL_MACHENISM = 'PLAIN'
SCHEMA_REGISTRY_API_KEY = 'GXXMXC2G4J7MWJNP'
SCHEMA_REGISTRY_API_SECRET = '1gydUZ2Sr9/UDPECVD19WjmuVZ/P1JxhqmQFMUs9WqMlOR+qbcBhIQ3RXBRKXfoW'
